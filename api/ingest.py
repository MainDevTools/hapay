...
HTML_SOURCES: dict[str, dict] = {
    ...
    # ЄМНІСТЬ ЧЕРГИ: 226 задач / 12 год ≈ 18.8 оренд/год при 20/год, які дає застосунок
    # (5 за прохід, раз на годину). Запас майже вичерпано — після Allo додавати
    # лістинги можна лише разом зі зростанням оренди за прохід, інакше глибокі
    # сторінки просто не встигатимуть оновлюватись.
