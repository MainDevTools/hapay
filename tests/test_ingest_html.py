...
def test_queue_load_fits_collector_capacity():
    ...
    Далі мінус хаб-задачі, яких у конфігу НЕМАЄ, а черга однаково виконує: Allo-хаб
    (~10 акційних лендингів) і add.ua-discover (до 60 сторінок товарів дермокосметики —
    двофазний збір, бо штрихкод там лише в товарі). Разом ~90. Плюс мінус 5% на повтори.
