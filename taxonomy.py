...
SECTION_ORDER = {"Електроніка": 1, "Фото-відео": 2, "Офісна техніка": 3,
                 "Побутова техніка": 4, "Клімат": 5, "Енергія": 6, "Краса і догляд": 7,
                 "Інструменти": 8, "Садова техніка": 9, "Авто": 10, "Спорт": 11,
                 "Дитячі товари": 12, "Медтехніка": 13, "Зоотовари": 14, "Аптека": 15,
                 "Інше": 16}
