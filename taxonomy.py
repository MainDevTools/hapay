...
SECTION_ORDER = {"Електроніка": 1, "Фото-відео": 2, "Офісна техніка": 3,
                 "Побутова техніка": 4, "Клімат": 5, "Енергія": 6, "Розумний дім": 7,
                 "Краса і догляд": 8, "Інструменти": 9, "Садова техніка": 10,
                 "Авто": 11, "Спорт": 12, "Дитячі товари": 13, "Медтехніка": 14,
                 "Зоотовари": 15, "Аптека": 16, "Інше": 17}
