...
SECTION_ORDER = {"Електроніка": 1, "Фото-відео": 2, "Побутова техніка": 3, "Клімат": 4,
                 "Краса і догляд": 5, "Інструменти": 6, "Садова техніка": 7, "Авто": 8,
                 "Спорт": 9, "Дитячі товари": 10, "Зоотовари": 11, "Аптека": 12,
                 "Інше": 13}
