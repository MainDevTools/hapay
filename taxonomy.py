...
SECTION_ORDER = {"Електроніка": 1, "Фото-відео": 2, "Офісна техніка": 3,
                 "Побутова техніка": 4, "Клімат": 5, "Краса і догляд": 6, "Інструменти": 7,
                 "Садова техніка": 8, "Авто": 9, "Спорт": 10, "Дитячі товари": 11,
                 "Медтехніка": 12, "Зоотовари": 13, "Аптека": 14, "Інше": 15}
