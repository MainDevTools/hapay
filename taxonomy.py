...
SECTION_ORDER = {"Електроніка": 1, "Побутова техніка": 2, "Клімат": 3,
                 "Краса і догляд": 4, "Інструменти": 5, "Садова техніка": 6, "Авто": 7,
                 "Спорт": 8, "Дитячі товари": 9, "Зоотовари": 10, "Аптека": 11,
                 "Інше": 12}
