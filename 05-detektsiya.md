...
> **⚠ Назви станів у цій таблиці — ВНУТРІШНІ (механіка).** Колонка «Що каже користувачу» описує сенс, **не видиму мітку**: за **T12/§5.4.1** видимий шар вердикту не висловлює («накачали» / «фейк» — не показуємо). Енум лишається як є; переписати видимі мітки на виміряні метрики — 🟡 відкрите.
