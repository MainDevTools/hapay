...
> **Свідомий залишок: КОЛІР.** Зелений/бурштиновий/сірий лишаємо — це кодування **виміру** (нижче / не нижче / невідомо), як у трекерах цін, і без нього продукт не сканується очима. Але чесно: колір — теж сигнал, і бурштин читається як «увага». Ми прибрали вердикт зі **слів і символів**, не з палітри. Якщо юрист (S8 Фаза 5) скаже «ви пофарбували нас у бурштин» — це аргумент, на який треба буде відповідати; тримати в полі зору.
